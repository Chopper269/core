...

{
    ...
    while (srt[longitud] != '\0')   //cuando (while) srt (el valor que recibe la funcion) es diferente a 0, entra en el bucle (o sigue en el)
...
{
    char ejemplo[] = "pruebita";    //main de prueba, declara una variable ejemplo con la palabra a contar

    printf (ft_strlen(ejemplo));    //imprime por pantalla la funcion ftstrlen con el valor ejemplo
