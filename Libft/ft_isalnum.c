...
int main() {//declaracion de main. Es un entero porque retorna un 0 al final, y es void porque no tiene argumentos de entrada
    ...
    entrada = '5'; //asigna un valor de entrada, aqui puedes poner lo que quieras
    resultado = ft_isalnum (entrada); //asigna un valor a resultado ejecutando ft_isalnum con la variable de entrada
    resultado2 = isalnum (entrada); //asigna un valor a resultado2 ejecutando isalnum con la variable de entrada

    //Ejecucion del programa
    printf("resultado mio %d\n", resultado); //muestra por pantalla el resultado con ft_isalnum
    printf("resultado original %d\n", resultado2); //muestra por pantalla el resultado con isalnum
