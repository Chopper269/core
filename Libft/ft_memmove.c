...
void    *ft_memcpy(void *dest, void *ori, size_t tam){   // Definimos las varibles destino y origen, y su tamanio. Son void porque puede ser cualquier dato. const es que es un valor constante, no varia
...
// Desarrollo del main
    ...
    int main(){
        ...
        ft_memmove(destino1, origen1, strlen(origen1)); //(ojo, el +1 es para copiar el caracter nulo de fin de la cadena)
